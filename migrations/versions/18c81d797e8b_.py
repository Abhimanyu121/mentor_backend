...
Revision ID: 18c81d797e8b
Revises: 
Create Date: 2019-06-20 14:23:17.208216
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['mentee'], ['user_profile.email'], ),
    sa.ForeignKeyConstraint(['mentor'], ['user_profile.email'], ),
    sa.ForeignKeyConstraint(['topic_name'], ['topics.topic_name'], ),
    ...
    sa.ForeignKeyConstraint(['email'], ['user_profile.email'], ),
    sa.ForeignKeyConstraint(['topic_name'], ['topics.topic_name'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['recipient'], ['user_profile.email'], ),
    sa.ForeignKeyConstraint(['sender'], ['user_profile.email'], ),
    sa.ForeignKeyConstraint(['topic_name'], ['topics.topic_name'], ),
    ...
    sa.ForeignKeyConstraint(['requester'], ['user_profile.email'], ),
    sa.PrimaryKeyConstraint('id')
    )
